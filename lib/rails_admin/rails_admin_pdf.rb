...
=begin
        ...
        Prawn::Document.new(PDF_OPTIONS) do |pdf|
          ...
          pdf.text "Relatório do Representante",
                   :size => 32, :style => :bold, :align => :center
          pdf.move_down 80

          pdf.text "Dados Pessoais",
                   :size => 14, :align => :justify, :inline_format => true, :style => :bold
          pdf.move_down 14

          if @object.lName
            pdf.text "Nome: #{@object.lName}",
...
=begin
          ...
          if @object.document
            pdf.text "Documento: #{@object.document}",
                     :size => 12, :align => :justify, :inline_format => true
            pdf.move_down 8
          end
=end
