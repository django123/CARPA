...
ActiveRecord::Schema.define(version: 2018_07_20_171637) do
  ...
  create_table "entry_couriers", force: :cascade do |t|
    ...
    t.index ["statut_id"], name: "index_entry_couriers_on_statut_id"
  ...
  create_table "statut_couriers", force: :cascade do |t|
    t.string "statut"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
